...
from apps.accounts.views import BusinessAdminSignupView, BusinessUserViewSet, CurrentUserView
...
urlpatterns = [
    ...
    path('api/auth/signup/', BusinessAdminSignupView.as_view(), name='business_admin_signup'),
